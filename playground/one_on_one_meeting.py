...
disagreement_agent = BaseAgent(
    agent_name='DisagreementAgent',
    system_message=(
...
agreement_agent = BaseAgent(
    agent_name='AgreementAgent',
    system_message=(
...
assistant_agent = BaseAgent(
    ...
    system_message=(
        ...
        "- 不討論自動化。\n"
        "- 如果無法協助，說明無法協助的理由。\n"
        "- 如果討論沒有新的更新，不再整理對話內容，簡單回復【會議結束】。注意不允許在整理對話中出現結束提示!\n"
    ),
    llm_config=llm_config,
)
